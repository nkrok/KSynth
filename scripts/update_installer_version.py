...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=KSynth Demo Installer\n"
      else:
        line="OutputBaseFilename=KSynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the KSynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the KSynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=KSynth Demo installer\n"
     else:
       line="SetupWindowTitle=KSynth installer\n"
