...
def main():
  ...
  plistpath = scriptpath + "/resources/KSynth-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/KSynth-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/KSynth-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/KSynth-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/KSynth-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/KSynth.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/KSynth.iss",inplace=1):
